...
// 人活在这个世上，总要坚持一些看起来很蠢的事，但这才是最难的。一次把持不住，之前的坚守就会变成笑话。

/**
 * Created by v on 16/5/23.
 */
public class RedPointExploredView extends FrameLayout {
    ...
    public RedPointExploredView(Context context) {
        super(context);
        initView();
    }

    public RedPointExploredView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public RedPointExploredView(Context context, AttributeSet attrs, int defStyle) {
